...
const AboutItem = ({header, text, icon}: AboutItemProps) => {
  return (
    ...
    border-solid border-[1px] border-transparent rounded-2xl p-5 lg:p-6 text-center
    transition ease-linear duration-300'>
      <div className='flex justify-center m-auto text-liBg group-hover:text-liSec dark:text-primaryAlt text-2xl mb-4'>
        {icon}
      </div>
      <h1 className='flex justify-center m-auto text-base text-liBg dark:text-white'>{header}</h1>
